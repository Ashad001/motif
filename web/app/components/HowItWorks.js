...
function HowItWorks() {
    return (<div id="how" style={{
      ...
      <div style={{
        ...
        {STEPS.map((step, i) => (<div key={step.num} className="step-card fade-up" style={{
                background: "var(--bg)",
                padding: "2.4rem 1.8rem",
                borderLeft: i > 0 ? "1px solid var(--border-mid)" : undefined,
                transition: "background 0.22s",
                transitionDelay: `${i * 0.08}s`,
            }} onMouseEnter={(e) => (e.currentTarget.style.background = "var(--card)")} onMouseLeave={(e) => (e.currentTarget.style.background = "var(--bg)")}>
            <span style={{
                fontFamily: "var(--font-mono), monospace",
                fontSize: "0.62rem",
            ...
            <span style={{ fontSize: "1.25rem", marginBottom: "1rem", display: "block" }}>
              {step.glyph}
            </span>
            <div style={{
                fontFamily: "var(--font-bebas), sans-serif",
